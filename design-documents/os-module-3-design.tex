...
This is implemented in the ft_get_lru_frame function, which uses pagedir_set_accessed and pagedir_is_accessed functions to determine the accessed status of a page.
